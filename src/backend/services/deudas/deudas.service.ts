import type { IDeudaRepository, DeudaConRelaciones } from '@/shared/repositories/IDeudaRepository';
import type { DeudasPendientes, DeudaItem } from '@/shared/types/deudas';
