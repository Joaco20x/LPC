...
describe("registrarGasto", () => {
  it("crea un gasto con divisiones y genera deudas", async () => {
    const { gastoRepo, divisionRepo, deudaRepo, miembroRepo, db } =
      crearMocks();
    ...
    await registrarGasto(
      {
        ...
        monto: 300,
        divisiones: [
          { idUsuario: "u1", montoAsignado: 150, tipoDivision: "exacto" },
          { idUsuario: "u2", montoAsignado: 150, tipoDivision: "exacto" },
        ],
      },
      gastoRepo,
      divisionRepo,
